...
CDSCO notification: not explicitly declared in public OxyPure listing. Sanrai as an India-based manufacturer-importer typically holds relevant registrations; buyers should request notification number ([CDSCO](https://cdsco.gov.in/opencms/opencms/en/Medical-Device-Diagnostics/Medical-Device-Diagnostics/)).
