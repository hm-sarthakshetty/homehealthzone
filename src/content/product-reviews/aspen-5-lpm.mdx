...
The 21 kg chassis is heavier than the class average of 15-17 kg. Comparable to Healthgenie (21 kg) and materially heavier than Home Medix HM-KV (13 kg), Nareena (15 kg), or Vandelay (14.5 kg). One adult can lift it but it requires more effort than the lightweight 5 LPM models. For buyers who need to move the machine between rooms multiple times a day, this is a friction. For fixed-placement use it does not matter.
...
**Home Medix HM-KV 5 LPM (₹37,800).** Home Medix publishes ≤40 dB field-verified sound, 13 kg weight, 320 VA draw, OPI, live purity analyzer, integrated nebulization, CDSCO + ISO 9001 + ISO 13485 documentation, and a 3-year / 10,000-hour warranty. Against Aspen, Home Medix is lighter, more efficient, stronger on alarms and paperwork, and less expensive at current indicative retail.
...
- **Home Medix HM-KV (₹37,800):** CDSCO + ISO documentation, ≤40 dB field-verified, 320 VA, OPI, live purity analyzer, 3-year / 10,000-hour warranty
