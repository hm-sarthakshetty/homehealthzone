...
CDSCO notification: not declared in the public Niscomed listing ([CDSCO](https://cdsco.gov.in/opencms/opencms/en/Medical-Device-Diagnostics/Medical-Device-Diagnostics/)). For a ₹91,200 purchase this is a critical gap. Medical Devices Rules 2020 require Class B notified device registration for all oxygen concentrators sold in India. Buyers should demand the notification number; absence should be a deal-breaker.
