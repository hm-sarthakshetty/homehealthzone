...
CDSCO notification: not explicitly declared on the public Oxyflow listing, though Sanrai as an India-based manufacturer-importer typically holds medical device registrations. Buyers should request the notification number from the dealer ([CDSCO](https://cdsco.gov.in/opencms/opencms/en/Medical-Device-Diagnostics/Medical-Device-Diagnostics/)).
