...
CDSCO MD-14 licensing for the importer is mandatory; verify the licence number and the importer's current active status before purchase. ([CDSCO](https://cdsco.gov.in/opencms/opencms/en/Medical-Device-Diagnostics/Medical-Device-Diagnostics/))
