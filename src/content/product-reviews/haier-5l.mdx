...
CDSCO MD-14 compliance must be verified separately for the medical-device SKU. Haier's consumer-appliance compliance framework does not extend to medical devices. ([CDSCO](https://cdsco.gov.in/opencms/opencms/en/Medical-Device-Diagnostics/Medical-Device-Diagnostics/))
