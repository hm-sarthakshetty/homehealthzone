...
CDSCO notification: not declared in the public Keyhub listing ([CDSCO](https://cdsco.gov.in/opencms/opencms/en/Medical-Device-Diagnostics/Medical-Device-Diagnostics/)). For a ₹42,240 purchase the buyer should demand the notification number. Medical Devices Rules 2020 require Class B notified medical device registration for all oxygen concentrators sold in India.
