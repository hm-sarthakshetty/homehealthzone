...
CDSCO approval status is not stated in the published key features or additional details for this SKU in the data we reviewed ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). Inogen has an established Indian regulatory pathway for the portable line; verify the at Home-specific SKU registration with your dealer.
