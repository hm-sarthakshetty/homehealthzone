...
CDSCO classification for the adjustable-purity category is inconsistent. Some units are registered as Class B medical devices (oxygen concentrators), others as household enrichment appliances outside CDSCO's explicit scope. Yobekan's specific registration should be confirmed with the importer before purchase. ([CDSCO](https://cdsco.gov.in/opencms/opencms/en/Medical-Device-Diagnostics/Medical-Device-Diagnostics/))
