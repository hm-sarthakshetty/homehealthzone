...
CDSCO MD-14 compliance is the minimum documentation to verify before purchase. Ask the dealer for the importer's MD-14 licence number and the specific batch/import date. For Taiwan-origin devices the Indian customs clearance path is generally cleaner than for mainland China imports, but the CDSCO licensing is the same. ([CDSCO](https://cdsco.gov.in/opencms/opencms/en/Medical-Device-Diagnostics/Medical-Device-Diagnostics/))
