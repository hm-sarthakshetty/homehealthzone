...
CDSCO status is not stated in the published key features or additional details for this SKU in the data we reviewed ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). Check the specific SKU with your supplier before any hospital-channel purchase.
