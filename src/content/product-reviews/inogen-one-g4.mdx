...
CDSCO approval status is not stated in the published key features or additional details for this SKU in the data we reviewed ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). Discontinued SKUs frequently have lapsed Indian registration; verify with the dealer.
