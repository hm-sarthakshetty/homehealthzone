...
CDSCO approval status is not stated in the published key features or additional details for this SKU in the data we reviewed ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). Check the specific SKU's registration status with your supplier before any hospital-channel purchase. Airsep as a brand rolled up under CAIRE and the India regulatory footprint has shifted — a direct check is advisable.
