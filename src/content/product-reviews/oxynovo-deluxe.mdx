...
CDSCO MD-14 importer licensing verification is the minimum due diligence before purchase. Ask for the specific import batch, the importer's MD-14 number, and a written service commitment. ([CDSCO](https://cdsco.gov.in/opencms/opencms/en/Medical-Device-Diagnostics/Medical-Device-Diagnostics/))
