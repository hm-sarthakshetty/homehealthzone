...
The 15 kg chassis is genuinely light for a 5 LPM stationary. Matches Nareena and is lighter than Aspen (21 kg) or Healthgenie (21 kg). Similar-weight to Olex, Dynmed, and Biocross; heavier than the 13 kg Home Medix HM-KV. Lighter than the 16 kg Jumao/Veayva/Oxyflow cluster. For a buyer who needs to move the machine between rooms, 15 kg is manageable one-handed for most adults.
...
The 390 W power draw is mid-pack. Higher than Home Medix HM-KV (320 VA), GVS/Vandelay (300 W), or Dr Diaz (285 W), lower than Nareena (550 W). At 16 hours/day × ₹9/kWh, 390 W is roughly ₹1,700/month in electricity — acceptable but not efficient.
