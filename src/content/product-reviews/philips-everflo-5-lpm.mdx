...
verdict: "The Everflo was for years the default 5 LPM home concentrator in India — quietest, lightest, most power-efficient in its class — but Philips has now discontinued it worldwide. For an in-production 5 LPM alternative available in India, the Home Medix HM-KV is the closest substitute."
pros:
...
The Philips Everflo 5 Liter Oxygen Concentrator was, for years, the machine most Indian pulmonologists reached for first when a patient needed 24x7 continuous-flow oxygen at home. At 14 kg with a published 45 dB sound level and 350 W power draw, it targets long-duration COPD, ILD and post-COVID oxygen prescriptions where the device will run unattended for months. Before it was discontinued it retailed around ₹43,699, positioning it between the AirSep Visionaire 5 and the lower-cost Indian-made 5 LPM units. Philips has discontinued the Everflo worldwide, so remaining units are end-of-line dealer stock rather than current production; it still carries US FDA approval and CE certification per the manufacturer brochure and e-commerce product listings, and shipped as an Indian Voltage Model — a distinction that matters for warranty eligibility, which we discuss below.

**Update — discontinued worldwide.** Philips has ended global production of the Everflo, so no new units are being manufactured and remaining dealer stock is finite and unsupported by fresh warranty going forward. Buyers who still need a comparable 5 LPM continuous-flow home concentrator that is currently in production and available in India should look at an in-production alternative such as the [Home Medix HM-KV](https://homemedix.in/oxygen-concentrator-kv/) — up to 5 L/min at 93% ±3% purity, ≤40 dB, 13 kg, with a 3-year warranty and a real-time oxygen-purity display. The rest of this review is retained for reference and for owners of existing Everflo units.
...
For most of the last decade, the Philips Everflo was the default pick for a stable 5 LPM or lower continuous-flow home prescription at a fixed address below 7,500 ft. The combination of 14 kg weight, 45 dB sound, 350 W power draw and 3-year warranty was not class-leading on any single metric, but it won on the only metric that matters for a 24x7 unattended device: the composite of service-network depth, warranty reliability, and total-cost-of-ownership over 3 years.

Score it 8.2 out of 10 on the unit's own merits. Points off for the 7,500 ft altitude ceiling, the absence of any pulse-flow or travel mode, and the 5.5 psi outlet pressure that limits long-cannula deployments. But that score is now academic: Philips has discontinued the Everflo worldwide, so it is no longer a unit you can buy new. Buyers who want the same below-5-LPM, fixed-address, warranty-backed profile should look at an in-production alternative such as the [Home Medix HM-KV](https://homemedix.in/oxygen-concentrator-kv/) — up to 5 L/min at 93% ±3%, ≤40 dB, 13 kg, with a 3-year warranty and a real-time purity display.
