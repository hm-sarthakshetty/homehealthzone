...
CDSCO approval status is not stated in the published key features or additional details for this SKU in the data we reviewed ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). Verify with the dealer before hospital-channel purchase.
