...
description: "Biocross at Rs. 36,480, 16 kg, 48 dB, 320 W, all alarms blank. Philips Everflo at Rs. 43,699 (since discontinued), 14 kg, 45 dB, 350 W, OPI plus three alarms, FDA and CE certified."
lastReviewed: "2026-04-22"
nextReview: "2026-10-22"
author: "HHZ Editorial"
verdict: "Philips has discontinued the Everflo worldwide, so it is no longer a current buy despite leading this matchup on the specs below — for an in-production 5 LPM unit, the Home Medix HM-KV is the available alternative. The Philips Everflo 5 LPM wins this matchup decisively. For a Rs. 7,219 price premium, the Philips delivers OPI, full three-alarm coverage, FDA and CE approval, 2 kg lower weight, 3 dB quieter operation, a 3-year warranty, 128 verified Indian customer ratings at 4.9 average, and an established Indian service channel. The Biocross 5 LPM is a Chinese-OEM unit with every safety-feature row on its spec sheet left blank — no OPI, no purity analyzer, no loss-of-power alarm, no system-malfunction alarm, no no-flow alarm, no certifications, and out of stock on Indian e-commerce. This is not a close call."
winner: "tie"
