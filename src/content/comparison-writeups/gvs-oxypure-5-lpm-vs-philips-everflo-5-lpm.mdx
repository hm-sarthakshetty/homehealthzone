...
verdict: "Philips has discontinued the Everflo worldwide, so it is no longer a current buy despite leading this matchup on the specs below — for an in-production 5 LPM unit, the Home Medix HM-KV is the available alternative. The Philips Everflo 5 LPM is the better pick for most Indian households on FDA approval, service network, and alarm suite. The GVS Oxypure wins on upfront price and nominal power draw but loses on dealer density and certifications."
winner: "tie"
...
- **Price (indicative retail):** GVS Oxypure ₹33,599 vs Everflo ₹43,699 — a ₹10,100 gap favouring the GVS
