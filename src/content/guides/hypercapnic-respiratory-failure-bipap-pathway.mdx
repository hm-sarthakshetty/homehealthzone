...
answer: "Hypercapnic respiratory failure means ventilation is inadequate and carbon dioxide is accumulating. BiPAP/NIV can add inspiratory pressure support to increase ventilation, whereas oxygen alone raises oxygen saturation without correcting CO₂ clearance and can worsen retention in susceptible patients. Acute hypercapnia—especially with acidosis, confusion, or severe breathlessness—is an emergency requiring monitored medical treatment, not home device selection."
faqs:
  - q: "Can oxygen alone treat high carbon dioxide?"
    a: "No. Oxygen treats low oxygen levels but does not supply the ventilation needed to remove carbon dioxide. In susceptible patients, uncontrolled oxygen can aggravate CO₂ retention, so both gases and clinical status must be monitored."
  - q: "Why is BiPAP used instead of CPAP for hypercapnia?"
    a: "The difference between IPAP and EPAP provides pressure support that can increase tidal volume and reduce the work of breathing. CPAP mainly supplies one airway-splinting pressure."
  - q: "Can BiPAP for hypercapnia be started at home?"
    a: "Acute or unexplained hypercapnia needs urgent assessment and monitored initiation. Stable chronic home NIV can follow a specialist pathway with prescribed settings, gas-exchange checks, education, and follow-up downloads."
---
