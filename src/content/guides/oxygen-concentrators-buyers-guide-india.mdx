...
faqs:
  ...
  - q: "Which oxygen concentrator brands are reliable in India?"
    a: "Reliability in India is mostly a service-network question. Philips and Nidek lead the import tier on service depth (with the EverFlo now discontinued globally — check the caveat before buying); Oxymed and BPL have the deepest Indian networks in the value tier; Home Medix pairs an Indian service address with the longest warranty in its band (3-year / 10,000-hour). Confirm an authorised service point within reach of your city before any purchase."
---
