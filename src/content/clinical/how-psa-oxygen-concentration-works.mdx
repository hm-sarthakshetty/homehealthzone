...
answer: "A PSA oxygen concentrator compresses room air and alternates it through zeolite-filled sieve beds that preferentially adsorb nitrogen. One bed produces oxygen-enriched gas while the other depressurizes and purges; rapid cycling creates continuous output. The usual 93% ±3% product is limited partly by argon, which is not separated efficiently by standard medical PSA."
faqs:
  - q: "Does an oxygen concentrator make or store oxygen?"
    a: "It separates oxygen already present in room air and usually stores only a small buffer volume inside the machine. It does not contain a refillable high-pressure oxygen supply."
  - q: "Why is concentrator oxygen about 93% rather than 100%?"
    a: "Zeolite removes nitrogen efficiently but standard PSA does not separate argon from oxygen well. Residual argon plus small process losses set the practical medical-concentrator range."
  - q: "Why do sieve beds wear out?"
    a: "Moisture, dust, oil contamination, valve timing problems, and long-term zeolite attrition reduce nitrogen adsorption. High humidity and inadequate filtration accelerate the decline."
---
