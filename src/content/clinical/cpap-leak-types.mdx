...
answer: "CPAP leak can be normal intentional vent flow, an unintended mask-seal leak, or air escaping through the mouth. Diagnose it from the report's leak pattern, mask fit at treatment pressure, dryness, and whether the mouth opens during sleep; do not compare raw leak numbers across brands until you know whether the platform reports total leak or estimated unintentional leak."
faqs:
  - q: "Is some CPAP mask leak normal?"
    a: "Yes. Every vented mask deliberately releases air to clear exhaled carbon dioxide. The problem is excess unintentional leak beyond that designed vent flow."
  - q: "How can I tell a mask leak from a mouth leak?"
    a: "Mask leaks often change with position or improve when the cushion is reseated; mouth leaks commonly accompany dry mouth and long leak plateaus. Report shape and an awake fit check at therapy pressure help separate them."
  - q: "Will a full-face mask fix every CPAP leak?"
    a: "No. It can contain oral leak, but it has a larger sealing surface and can itself leak. Correct size, cushion condition, hose routing, and pressure-time fit still matter."
---
