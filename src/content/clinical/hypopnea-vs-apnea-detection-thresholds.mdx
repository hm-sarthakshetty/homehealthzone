...
answer: "In adult sleep-study scoring, an apnea is generally a ≥90% airflow reduction lasting at least 10 seconds. A hypopnea is a smaller qualifying airflow reduction lasting at least 10 seconds plus the required oxygen desaturation or arousal under the scoring rule used. CPAP machines infer events from flow without EEG or full effort signals, so their AHI is useful for trends but is not identical to polysomnography AHI."
faqs:
  - q: "What is the main difference between apnea and hypopnea?"
    a: "An apnea is near-complete loss of airflow; a hypopnea is partial reduction that also meets a desaturation or arousal criterion in formal sleep-study scoring."
  - q: "Why does CPAP AHI differ from sleep-study AHI?"
    a: "A CPAP estimates events from its own airflow and pressure signals while a sleep study also measures sleep time, brain arousals, oxygen, and respiratory effort. Awake time and brand algorithms create further differences."
  - q: "Are hypopneas less important than apneas?"
    a: "Not necessarily. Repeated hypopneas can cause substantial oxygen drops and sleep fragmentation; overall frequency, duration, desaturation, symptoms, and comorbidity determine clinical importance."
---
