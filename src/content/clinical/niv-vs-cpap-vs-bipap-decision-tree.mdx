...
answer: "CPAP supplies one continuous pressure to splint an obstructed upper airway. BiPAP supplies higher inspiratory and lower expiratory pressures, adding pressure support for ventilation; ST and volume-assured modes add further control. NIV is the broader treatment category, while a home ventilator adds alarms, circuits, batteries, and life-support capabilities for patients who need more dependable ventilation. The diagnosis and gas-exchange problem—not the brand name—select the mode."
faqs:
  - q: "Is NIV the same as BiPAP?"
    a: "BiPAP is a commonly used form of non-invasive ventilation, but NIV is broader and also includes other pressure-support and volume-assured modes delivered without an invasive airway."
  - q: "When is BiPAP preferred over CPAP?"
    a: "It is considered when ventilation or carbon-dioxide clearance is inadequate, when a large pressure difference is needed, or when specific bilevel modes are clinically indicated—not simply because BiPAP is a more expensive machine."
  - q: "When is a home ventilator needed instead of a BiPAP?"
    a: "A ventilator becomes relevant when dependence, alarm requirements, backup power, circuit options, secretion management, or disease progression exceed what a sleep-therapy bilevel can safely provide."
---
...
**Typical devices:** ResMed AirSense 10, AirSense 11, AirStart 10; Philips DreamStation CPAP; BMC GII Auto; BPL Harmony Auto; Oxymed Auto CPAP; [Home Medix HM-CV-20](https://homemedix.in/cpap/) (CPAP/APAP, 4–20 cmH₂O). Price range ₹30,000–1,10,000.
...
**Typical devices:** ResMed AirCurve 10 ST, Lumis 100 VPAP ST; Philips DreamStation BiPAP (with ST capability); BMC Y30T; [Home Medix HM-BV-30](https://homemedix.in/bpap/); BPL LifePap 25 STa. Price range ₹1,00,000–2,50,000.
...
**Typical devices:** ResMed Lumis VPAP ST-A (iVAPS); Philips DreamStation BiPAP AVAPS; [Home Medix HM-BV-30](https://homemedix.in/bpap/) (TVAPS mode); BMC G3 B30VT. Price range ₹1,40,000–3,00,000.
