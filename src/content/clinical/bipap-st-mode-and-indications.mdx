...
answer: "BiPAP-ST adds a timed backup breath when a patient does not trigger one. It is considered for central apnea, neuromuscular weakness, obesity hypoventilation, chronic hypercapnic respiratory failure, and other conditions with unreliable respiratory drive; routine obstructive sleep apnea with intact drive usually does not require ST mode. Mode and backup-rate settings require clinician-led titration."
faqs:
  - q: "What is the difference between BiPAP S and BiPAP ST?"
    a: "S mode changes between IPAP and EPAP only when the patient triggers a breath. ST mode also delivers timed breaths at a prescribed backup rate when spontaneous triggering is absent or too slow."
  - q: "Who needs a backup rate on BiPAP?"
    a: "It is most relevant when breathing drive or muscle strength can become inadequate, including central apnea, neuromuscular disease, obesity hypoventilation, and selected chronic hypercapnic conditions."
  - q: "Can a patient set the BiPAP backup rate themselves?"
    a: "No. An inappropriate rate or timing can create poor synchrony or inadequate ventilation. A sleep or respiratory clinician should set and review it using symptoms, gas exchange, and device data."
---
