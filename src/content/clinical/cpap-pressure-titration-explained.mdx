...
answer: "CPAP titration finds the pressure that controls obstructive events across sleep stages and positions. An attended sleep lab adjusts pressure while measuring sleep and breathing directly; a home APAP trial infers a useful range from several nights of device data. A 90th- or 95th-percentile pressure is evidence for clinical review, not automatically a new prescription."
faqs:
  - q: "Is laboratory CPAP titration better than home auto-titration?"
    a: "A lab sees sleep stages, position, effort, oxygen, and arousals directly and is preferable for complex disease. Home APAP is more accessible and can work well for uncomplicated obstructive sleep apnea when follow-up data are reviewed."
  - q: "Should CPAP be set to the report's 95th-percentile pressure?"
    a: "Not automatically. That statistic can be inflated by leak or short periods of high need and does not show event type. It should be interpreted with the full report and symptoms."
  - q: "When should CPAP pressure be retitrated?"
    a: "Seek review when symptoms or residual events persist, weight or health changes substantially, central events appear, pressure becomes intolerable, or the original study no longer reflects the clinical picture."
---
