...
CE and FDA are not stated in the published key features or additional details for this SKU ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). Wellell as a corporate parent has CE marking across its European-distributed SKUs; the specific Indian SKU's current registration should be confirmed with the dealer. For hospital-channel or CGHS/ECHS reimbursement purchases, CDSCO Class B registration documentation will be required — confirm before purchase.
