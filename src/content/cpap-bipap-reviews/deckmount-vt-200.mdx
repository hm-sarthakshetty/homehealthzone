...
CE and FDA are not stated in the published key features or additional details for this SKU ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). For hospital-channel purchase where CDSCO Class B/C registration matters for procurement-compliance, confirm at point of sale.
