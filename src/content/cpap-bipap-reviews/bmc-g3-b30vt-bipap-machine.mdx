...
CDSCO registration for this specific SKU is not stated in the published additional details in the data we reviewed ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)); hospital-channel buyers should verify registration before issuing a PO.
