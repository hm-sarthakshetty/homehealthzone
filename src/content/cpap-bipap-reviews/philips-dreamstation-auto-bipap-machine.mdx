...
FAA approval (Yes) is explicitly listed and matters for Indian inflight BiPAP use — passengers carrying non-FAA-approved ventilatory devices face difficulty getting airline pre-clearance. For any BiPAP patient who flies regularly on Indian carriers, FAA approval is a load-bearing spec ([DGCA India](https://www.dgca.gov.in/)).
...
CDSCO registration should be verified with the Philips India authorised dealer for any hospital-channel purchase ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). Philips Respironics carries an established India regulatory presence, and CDSCO registration is routinely maintained on the main product lines.
