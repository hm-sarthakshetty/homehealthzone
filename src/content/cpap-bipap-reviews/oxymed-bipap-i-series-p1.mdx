...
CDSCO approval status is not stated in the published key features or additional details ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). CE is marked, FDA is not marked. For a ventilator-class prescription (BiPAP ST falls into a more stringent regulatory category than CPAP in most Indian hospital-procurement workflows), confirm CDSCO Class B/C registration with the dealer before purchase. A CGHS/ECHS/insurance claim will typically require documented CDSCO approval.
