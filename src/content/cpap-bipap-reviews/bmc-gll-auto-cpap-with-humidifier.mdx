...
CDSCO registration is not stated in the published additional details for this specific SKU in the data we reviewed ([CDSCO Medical Device Registry](https://cdscomdonline.gov.in/NewMedDev/Homepage)). Buyers working through hospital or institutional channels should confirm current registration with the supplier before issuing a PO.
