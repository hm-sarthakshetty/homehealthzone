...
Country of origin: India (Bengaluru-headquartered — Home Medix India Pvt Ltd; core compressor and sieves sourced internationally, the same assembly pattern as most Indian-assembled brands in this guide, Oxymed included).
...
Notable models: **Home Medix 5 LPM (HM-KV)** — ₹37,800 indicative retail, 13 kg, ≤40 dB field-verified sound, 320 VA, OPI, live purity analyzer, integrated nebulization, 3-year / 10,000-hour warranty, CDSCO + ISO 9001 + ISO 13485 documentation. **Home Medix 10 LPM (HM-KX)** — ₹65,000 indicative retail, 25.6 kg, ≤48 dB field-verified sound, 550 VA, integrated nebulization, 3-year / 10,000-hour warranty, CDSCO + ISO 9001 + ISO 13485 documentation.

Fit: One of the stronger spec sheets in the indigenous tier — class-leading 13 kg weight and ≤40 dB field-verified sound, OPI plus a live purity analyzer, integrated nebulization, and the longest warranty in the segment (3-year / 10,000-hour) backed by full CDSCO + ISO 9001 + ISO 13485 documentation. Where its service network reaches, it out-specs the cheaper indigenous-tier units (Dr Diaz, GVS, Oxybliss) on weight, sound, warranty, and purity monitoring. The binding caveat is service depth: its footprint is thinner than Oxymed's or BPL's, so confirm an authorised service point near you before deciding.
...
| Indian OEMs and entry brands (Nareena, Dr Diaz, GVS, Evox, Oxybliss, Fitmate etc.) | Low price, mixed service, often shorter warranties | Short-horizon use (post-COVID 3–9 months), backup unit, rental-fleet stock |
