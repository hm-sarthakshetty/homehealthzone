...
faqs:
  ...
  - q: "Which is the cheapest BiPAP with volume-assured ventilation in India?"
    a: "The Home Medix HM-BV-30 at an indicative ₹29,000 is the lowest-priced unit in HHZ's top five offering volume-assured ventilation — a sensible pick for OHS and progressive neuromuscular prescriptions where the physician requires volume assurance but the budget cannot reach the ResMed ST-A tier."
